 ...
 */
  ...
  return(
    <div onClick = {() => {setSelected(!selected)}} className = {`${selected ? selectedVariants.selected : selectedVariants.notSelected} ${(props.currentCard === props.originalPosition && props.animation === "right") ? "animate-right-next-appear" : (props.currentCard === props.originalPosition && props.animation === "left") ? "animate-left-next-appear" : ""}`}>
