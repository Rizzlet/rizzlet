 ...
 */
  ...
  onClick={() => {(props.correctAnswer == "true") ? console.log("yay") : console.log("aw")}}>
 ...
 */
  ...
  function FormatTrueFalseAnswer(){
    ...
    if (typeof(props.rightAnswer) == "boolean"){
     for (let i = 1; i >= 0; i--){
      answersElement.push(<IndividualAnswer
  ...
  return <div className={`h-5/6 flex-row justify-between ${(props.hidden === "visible" ? answerVariant.visible: answerVariant.hidden)}`}>{FormatTrueFalseAnswer()}</div>
