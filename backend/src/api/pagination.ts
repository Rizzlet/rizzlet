...
// export async function fetchPaginatedQuestion(req: CustomRequest, res: CustomResponse, next: express.NextFunction) {
//   try {
//     await paginatedResults(getAllUsersByScore(), req, res, next);
...
// async function paginatedResults(model: Model<Document>, req: CustomRequest, res: CustomResponse, next: NextFunction) {
